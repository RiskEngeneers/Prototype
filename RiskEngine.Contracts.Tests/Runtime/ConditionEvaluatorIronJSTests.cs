...
{
    [TestFixture]
    public class ConditionEvaluatorIronJSTests
    {
        ...
        {
            var result = _conditionEvaluator.Evaluate("return input.Bool && input.Str == 'A';", _runtimeMock.Object);
        ...
        {
            var result = _conditionEvaluator.Evaluate("input.Bool && input.Number == 1 && input.Str == 'A' && Provider1.Bool;", _runtimeMock.Object);
